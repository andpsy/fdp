...
namespace FDP
{
    public partial class VisitReasons : UserForm
    {
        //this.dataGrid1 = new FDP.DataGrid("VISITREASONSsp_select", null, "VISITREASONSsp_insert", null, "VISITREASONSsp_update", null, "VISITREASONSsp_delete", null, null, null, null, null, null, null, this.Selectable, false);
        ...
        public VisitReasons(bool selectable)
        {
            base.Maximized = FormWindowState.Maximized;
        ...
        public void buttonAdd_Click(object sender, EventArgs e)
        {
            ...
            DataRow visitreason = ((DataTable)((BindingSource)dataGrid1.dataGridView.DataSource).DataSource).NewRow();
            var f = new DynamicFormLists("visitreasons", visitreason, 0);
            EditMode = 1; // ADD
            main m = FindMainForm();
            f.Launcher = this;
        ...
        public void SaveAddRecord()
        {
            ...
            if (f.DialogResult == DialogResult.OK)
            {
                try
                {
                    DataRow visitreason = f.return_data_row;
                    object[] mySqlParams = dataGrid1.da.GenerateMySqlParameters(visitreason.Table, visitreason.ItemArray, 0);
                    ((DataTable)dataGrid1.da.bindingSource.DataSource).Rows.Add(visitreason);
        ...
        public void buttonEdit_Click(object sender, EventArgs e)
        {
            ...
            {
                DataRow visitreason = ((DataRowView)dataGrid1.dataGridView.SelectedRows[0].DataBoundItem).Row;
                var f = new DynamicFormLists("visitreasons", visitreason, 1);
                EditMode = 2; // EDIT
                main m = FindMainForm();
                f.Launcher = this;
                this.ChildLaunched = f;
        ...
        public void SaveEditRecord()
        {
            ...
            if (f.DialogResult == DialogResult.OK)
            {
                ...
                {
                    DataRow visitreason = f.return_data_row;
                    object[] mySqlParams = dataGrid1.da.GenerateMySqlParameters(visitreason.Table, visitreason.ItemArray, 1);
