...
namespace FDP
{
    public partial class RoomAssets : UserForm
    {
        //this.dataGrid1 = new FDP.DataGrid("ROOMASSETSsp_select", null, "ROOMASSETSsp_insert", null, "ROOMASSETSsp_update", null, "ROOMASSETSsp_delete", null, null, null, null, new string[]{"STATUS_ID"}, null, new string[]{"NAME", "PRODUCER", "NUMBER", "STATUS", "DETAILS"}, this.Selectable);
        ...
        public RoomAssets(bool selectable)
        {
            base.Maximized = FormWindowState.Maximized;
        ...
        public void buttonAdd_Click(object sender, EventArgs e)
        {
            ...
            DataRow roomasset = ((DataTable)((BindingSource)dataGrid1.dataGridView.DataSource).DataSource).NewRow();
            var f = new DynamicFormLists("roomassets", roomasset, 0);
            EditMode = 1; // ADD
            main m = FindMainForm();
            f.Launcher = this;
        ...
        {
            DynamicFormLists f = (DynamicFormLists)((main)FindMainForm()).Controls.Find(this.ChildLaunched.Name, true)[0];
            if (f.DialogResult == DialogResult.OK)
            {
                try
                {
                    DataRow roomasset = f.return_data_row;
                    object[] mySqlParams = dataGrid1.da.GenerateMySqlParameters(roomasset.Table, roomasset.ItemArray, 0);
                    ((DataTable)dataGrid1.da.bindingSource.DataSource).Rows.Add(roomasset);
        ...
        public void buttonEdit_Click(object sender, EventArgs e)
        {
            ...
            {
                DataRow roomasset = ((DataRowView)dataGrid1.dataGridView.SelectedRows[0].DataBoundItem).Row;
                var f = new DynamicFormLists("roomassets", roomasset, 1);
                EditMode = 2; // EDIT
                main m = FindMainForm();
                f.Launcher = this;
                this.ChildLaunched = f;
        ...
        public void SaveEditRecord()
        {
            ...
            if (f.DialogResult == DialogResult.OK)
            {
                ...
                {
                    DataRow roomasset = f.return_data_row;
                    object[] mySqlParams = dataGrid1.da.GenerateMySqlParameters(roomasset.Table, roomasset.ItemArray, 1);
        ...
        private void PropertyRooms_Load(object sender, EventArgs e)
        {
            //this.dataGrid1 = new FDP.DataGrid("ROOMASSETSsp_select", null, "ROOMASSETSsp_insert", null, "ROOMASSETSsp_update", null, "ROOMASSETSsp_delete", null, null, null, null, null, null, null, this.Selectable);
        }
    }
}
