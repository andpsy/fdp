...
namespace FDP
{
    public partial class RoomAssetsConditions : UserForm
    {
        public DataSet Content = new DataSet();
        public bool Selectable = false;

        public RoomAssetsConditions()
        {
        ...
        public RoomAssetsConditions(bool selectable)
        {
            base.Maximized = FormWindowState.Maximized;
        ...
        public void buttonAdd_Click(object sender, EventArgs e)
        {
            ...
            DataRow rac = ((DataTable)((BindingSource)dataGrid1.dataGridView.DataSource).DataSource).NewRow();
            var f = new DynamicFormLists("roomassetconditions", rac, 0);
            EditMode = 1; // ADD
            main m = FindMainForm();
            f.Launcher = this;
        ...
        public void SaveAddRecord()
        {
            ...
            if (f.DialogResult == DialogResult.OK)
            {
                try
                {
                    DataRow rac = f.return_data_row;
                    object[] mySqlParams = dataGrid1.da.GenerateMySqlParameters(rac.Table, rac.ItemArray, 0);
                    ((DataTable)dataGrid1.da.bindingSource.DataSource).Rows.Add(rac);
        ...
        public void buttonEdit_Click(object sender, EventArgs e)
        {
            ...
            {
                DataRow rac = ((DataRowView)dataGrid1.dataGridView.SelectedRows[0].DataBoundItem).Row;
                var f = new DynamicFormLists("roomassetconditions", rac, 1);
                EditMode = 2; // EDIT
                main m = FindMainForm();
                f.Launcher = this;
                this.ChildLaunched = f;
        ...
        public void SaveEditRecord()
        {
            ...
            if (f.DialogResult == DialogResult.OK)
            {
                ...
                {
                    DataRow rac = f.return_data_row;
                    object[] mySqlParams = dataGrid1.da.GenerateMySqlParameters(rac.Table, rac.ItemArray, 1);
