...
namespace FDP
{
    public partial class CompanyPredictedIncomeExpenseSelect : UserForm
    {
        //this.dataGrid1 = new FDP.DataGrid("COMPANY_PREDICTED_INCOME_EXPENSESsp_select", null, "COMPANY_PREDICTED_INCOME_EXPENSESsp_insert", null, "COMPANY_PREDICTED_INCOME_EXPENSESsp_update", null, "COMPANY_PREDICTED_INCOME_EXPENSESsp_delete", null, new string[] { "DATE" }, new string[] { "AMOUNT" }, null, new string[]{ "STATUS" }, new string[] { "OWNER", "PROPERTY" }, new string[] { "TYPE", "OWNER", "PROPERTY", "AMOUNT", "CURRENCY", "MONTH", "DATE", "SERVICE", "SERVICE_DESCRIPTION" }, this.Selectable, false);
        public bool Selectable = false;

        public CompanyPredictedIncomeExpenseSelect()
        {
        ...
        public CompanyPredictedIncomeExpenseSelect(bool selectable)
        {
            base.Maximized = FormWindowState.Maximized;
        ...
        private void CompanyPredictedIncomeExpenseSelect_Load(object sender, EventArgs e)
        {
        }
        ...
        public void buttonAdd_Click(object sender, EventArgs e)
        {
            ...
            var f = new CompanyPredictedIncomeExpenses(pie);
            ...
            if (f.DialogResult == DialogResult.OK)
            {
                try
                {
                    ...
                    */
                    try
                    {
                        pie["status"] = (new DataAccess(CommandType.StoredProcedure, "LISTSsp_get_by_id", new object[] { new MySqlParameter("_ID", pie["status_id"]) })).ExecuteScalarQuery().ToString();
                    }
                    catch { }
