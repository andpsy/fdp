namespace FDP
{
    partial class CoOwnerSelect
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.dataGrid1 = new DataGrid("CO_OWNERSsp_select", null, "CO_OWNERSsp_insert", null, "CO_OWNERSsp_update", null, "CO_OWNERSsp_delete", null, null, null, null, new string[] { "OWNER_ID" }, new string[]{"OWNER"}, new string[] { "NAME", "FULL_NAME", "CIF", "CUI", "CNP", "OWNER" }, this.Selectable, false);
            ...
            this.Name = "CoOwnerSelect";
            this.Text = "Co-Owner Select";
