...
namespace FDP
{
    public partial class CompanyPredictedIncomeExpenses : UserForm
    {
        public DataRow NewDR;
        public DataRow InitialDR;
        public ArrayList MySqlParameters = new ArrayList();

        public CompanyPredictedIncomeExpenses()
        {
            base.CheckDataOnClosing = true;
            InitializeComponent();
        }

        public CompanyPredictedIncomeExpenses(DataRow dr)
        {
            base.CheckDataOnClosing = true;
            NewDR = dr;
            InitializeComponent();
        ...
        private void CompanyPredictedIncomeExpenses_Load(object sender, EventArgs e)
        {
            FillCombos();
            if (NewDR != null)
            {
        ...
        private void buttonSave_Click(object sender, EventArgs e)
        {
            ...
            if (NewDR == null) //add direct
            {
                try
                {
                    DataAccess da = new DataAccess(CommandType.StoredProcedure, "COMPANY_PREDICTED_INCOME_EXPENSESsp_insert", MySqlParameters.ToArray());
