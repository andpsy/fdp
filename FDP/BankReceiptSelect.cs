...
namespace FDP
{
    public partial class BankReceiptSelect : UserForm
    {
        //this.dataGrid1 = new FDP.DataGrid("BANK_RECEIPTSsp_select", null, "BANK_RECEIPTSsp_insert", null, "BANK_RECEIPTSsp_update", null, "BANK_RECEIPTSsp_delete", null, new string[] { "DATE" }, new string[] { "AMOUNT_PAID" }, null, null, new string[] { "INVOICE" }, new string[] { "SERIES", "NUMBER", "DATE", "AMOUNT_PAID", "INVOICE" }, this.Selectable, false);
        public bool Selectable = false;

        public BankReceiptSelect()
        {
        ...
        public BankReceiptSelect(bool selectable)
        {
            base.Maximized = FormWindowState.Maximized;
        ...
        public BankReceiptSelect(int id, string id_type)
        {
            base.Maximized = FormWindowState.Maximized;
            InitializeComponent();
            dataGrid1.buttonAdd.Click += new EventHandler(buttonAdd_Click);
        ...
        private void BankReceiptSelect_Load(object sender, EventArgs e)
        {
        ...
        {
            BankReceipt f = (BankReceipt)((main)FindMainForm()).Controls.Find(this.ChildLaunched.Name, true)[0];
            if (f.DialogResult == DialogResult.OK)
            {
                try
                {
                    ...
                    try
                    {
                        DataRow invoice = (new DataAccess(CommandType.StoredProcedure, "BANK_RECEIPTSsp_get_invoice", new object[] { new MySqlParameter("_ID", cr["id"]) })).ExecuteSelectQuery().Tables[0].Rows[0];
